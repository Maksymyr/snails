    ...
    render() {
            ...
            <div className="book">
                ...
                <div className="book-inner">
                    ...
                    <Link onClick={this.scrolling} to={"/snails/page"+this.props.item.code}><img src={this.props.item.img? this.props.item.img: require('../../image/no-image.png')}/></Link>
                    ...
                    <p className="book_text"><Link onClick={this.scrolling} className="book_link" to={"/snails/page"+this.props.item.code}>{this.props.item.name}</Link></p>
                    <p className="book_author"><Link onClick={this.scrolling} className="book_link" to={"/snails/author/"+this.props.item.author}>{this.props.item.author}</Link></p>
